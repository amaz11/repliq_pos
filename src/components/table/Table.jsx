            ...
            <div className='mt-3 overflow-x-scroll'>
                <table className='w-full'>
                    <tbody className='group'>
                        {cart.map(item => <tr key={item.id} className=''>
                            <td className='w-10 px-1 py-2 text-slate-600'><FiEdit size={22} className='cursor-pointer' /></td>
                            <td className='border-t-2 border-l-2 border-b group:last:border-b-2 pl-2 rounded-tl text-slate-600 font-medium text-base'>{item.title}</td>
                            <td className='border-t-2 text-center border-b group:last:border-b-2 text-slate-600 font-medium text-base'>${item.price}</td>
                            <td className='border-t-2 border-b group:last:border-b-2'>
                                <div className='flex items-center justify-center gap-4 group:last:border-b-2 text-slate-600'>
                                    ...
                                    <span className='text-slate-600 font-medium text-base'>{item.quantity}</span>
                                    <AiOutlinePlusCircle onClick={() => increseQuantity(item.id)} size={24} className='cursor-pointer' />
                                </div>
                            </td>
                            <td className='border-t-2 border-r-2 text-right pr-3 border-b group:last:border-b-2 text-slate-600 font-medium text-base'>${item.price * item.quantity}</td>
                        ...
                        <tr>
                            ...
                            <td className='text-right pr-3 text-slate-700 font-medium text-base border-b'>${subTotal}</td>
                            <td className='text-center opacity-0'>n/a</td>
                        </tr>
                        <tr>
                            <td className='px-1 py-2 opacity-0'>n/a</td>
                            ...
                            <td className='text-right pr-3 text-slate-700 font-medium text-base border-b'>${tax}</td>
                            <td className='text-center opacity-0'>n/a</td>
                        </tr>
                        <tr>
                            <td className='px-1 py-2 opacity-0'>n/a</td>
                            ...
                            <td className='text-right pr-3 text-slate-700 font-medium text-base border-b'>${shipping}</td>
                            <td className='text-center opacity-0'>n/a</td>
                        </tr>
                        <tr >
                            <td className='px-1 py-2 opacity-0'>n/a</td>
                            ...
                            <td className='text-right pr-3 text-slate-700 font-medium text-base'>${discount}</td>
                            <td className='text-center opacity-0'>n/a</td>
                        </tr>
                        <tr className='mt-3 w-full rounded bg-[#E1EAF9] text-[#3674D9] total'>
                            <td className='opacity-0'></td>
                            <td className='pl-2 px-4 py-4 font-medium'>Product Count ({cart.length})</td>
                            <td className='text-center opacity-0'>n/a</td>
                            <td className='font-bold text-xl'>Total</td>
                            <td className='text-right pr-3 font-bold text-xl'>{(subTotal + tax + shipping) - discount}</td>
                            <td className='text-center opacity-0'>n/a</td>
                        </tr>
                    </tbody>
                </table>
