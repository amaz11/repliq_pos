...
const Error = () => {
    return (
        <div className="flex justify-center items-center bg-white p-5 w-full h-[calc(100vh-80px)]">
            <div className="text-center">
                <div className="inline-flex bg-red-100 p-4 rounded-full">
                    <div className="bg-red-200 p-4 rounded-full stroke-red-600">
                ...
                <h1 className="mt-5 font-bold text-[36px] text-slate-800 lg:text-[50px]">500 - Server error</h1>
                <p className="mt-5 text-slate-600 lg:text-lg">Oops something went wrong. Try to refresh this page or <br /> feel free to contact us if the problem presists.</p>
            </div>
        </div>
